...
resource "aws_vpc_peering_connection" "us_east_to_us_west" {
  ...
  vpc_id      = module.aws_us_east_1.vpc_id
  peer_vpc_id = module.aws_us_west_2.vpc_id
...
resource "aws_route" "us_east_to_us_west_public" {
  ...
  route_table_id            = module.aws_us_east_1.public_route_table_id
  destination_cidr_block    = module.aws_us_west_2.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_us_west.id
...
resource "aws_route" "us_east_to_us_west_private" {
  ...
  route_table_id            = module.aws_us_east_1.private_route_table_id
  destination_cidr_block    = module.aws_us_west_2.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_us_west.id
...
resource "aws_route" "us_west_to_us_east_public" {
  ...
  route_table_id            = module.aws_us_west_2.public_route_table_id
  destination_cidr_block    = module.aws_us_east_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_us_west.id
...
resource "aws_route" "us_west_to_us_east_private" {
  ...
  route_table_id            = module.aws_us_west_2.private_route_table_id
  destination_cidr_block    = module.aws_us_east_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_us_west.id
...
resource "aws_vpc_peering_connection" "us_east_to_eu_west" {
  ...
  vpc_id      = module.aws_us_east_1.vpc_id
  peer_vpc_id = module.aws_eu_west_1.vpc_id
...
resource "aws_route" "us_east_to_eu_west_public" {
  ...
  route_table_id            = module.aws_us_east_1.public_route_table_id
  destination_cidr_block    = module.aws_eu_west_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_eu_west.id
...
resource "aws_route" "eu_west_to_us_east_public" {
  ...
  route_table_id            = module.aws_eu_west_1.public_route_table_id
  destination_cidr_block    = module.aws_us_east_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_eu_west.id
...
resource "aws_route" "eu_west_to_us_east_private" {
  ...
  route_table_id            = module.aws_eu_west_1.private_route_table_id
  destination_cidr_block    = module.aws_us_east_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_eu_west.id
...
resource "aws_vpc_peering_connection" "us_east_to_ap_southeast" {
  ...
  vpc_id      = module.aws_us_east_1.vpc_id
  peer_vpc_id = module.aws_ap_southeast_1.vpc_id
...
resource "aws_route" "us_east_to_ap_southeast_public" {
  ...
  route_table_id            = module.aws_us_east_1.public_route_table_id
  destination_cidr_block    = module.aws_ap_southeast_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_ap_southeast.id
...
resource "aws_route" "ap_southeast_to_us_east_public" {
  ...
  route_table_id            = module.aws_ap_southeast_1.public_route_table_id
  destination_cidr_block    = module.aws_us_east_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_ap_southeast.id
...
resource "aws_route" "ap_southeast_to_us_east_private" {
  ...
  route_table_id            = module.aws_ap_southeast_1.private_route_table_id
  destination_cidr_block    = module.aws_us_east_1.vpc_cidr
  vpc_peering_connection_id = aws_vpc_peering_connection.us_east_to_ap_southeast.id
...
resource "aws_vpc_peering_connection" "eu_west_to_ap_southeast" {
  ...
  vpc_id      = module.aws_eu_west_1.vpc_id
  peer_vpc_id = module.aws_ap_southeast_1.vpc_id
  peer_region = "ap-southeast-1"
  auto_accept = false
